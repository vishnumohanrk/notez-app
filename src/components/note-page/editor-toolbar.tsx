...
export function EditorToolbar({ editor }: { editor: Editor }) {
  return (
    <ScrollArea
      ...
      rootClassName="!sticky top-0 z-10 overflow-hidden rounded-t-md border-b bg-neutral-800"
    >
      <Toolbar.Root
        aria-label="Formatting options"
        className="flex flex-nowrap items-center gap-2 px-4 py-2.5 [&>*]:shrink-0"
      >
        <div>
          <EditorButton
            Icon={Undo}
