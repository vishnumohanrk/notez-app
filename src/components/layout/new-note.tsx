...
export function NewNote({ variant }: { variant: 'full' | 'floating' }) {
  return (
    <Link
      href="/note/new"
      className={twMerge(
        'inline-flex h-14 items-center bg-indigo-700 font-medium focus:outline-none focus:ring-2 focus:ring-indigo-700 focus:ring-offset-2 focus:ring-offset-neutral-950',
        variant === 'floating'
